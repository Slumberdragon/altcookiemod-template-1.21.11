...
public class ModFoodComponents {
    ...
    public static final FoodProperties CREEPERCOOKIE = new FoodProperties.Builder().nutrition(3).saturationModifier(0.25f).build();
    public static final FoodProperties CHARGED_CREEPERCOOKIE = new FoodProperties.Builder().nutrition(3).saturationModifier(0.25f).build();
